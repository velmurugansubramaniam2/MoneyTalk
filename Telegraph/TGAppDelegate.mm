...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    [[TCSAuthorizationStateManager sharedInstance] determineCurrentState];
    
    [[TCSMTAnalytics sharedInstance] setupWithLaunchOptions:launchOptions];
    ...
    [[TCSMTConfigManager sharedInstance] updateConfig];
    
    [MTKeychainController sharedInstance];
