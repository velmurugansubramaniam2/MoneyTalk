...
@interface TGAccountSettingsController () <TGImagePickerControllerDelegate, TGLegacyCameraControllerDelegate, TGWallpaperControllerDelegate>
{
    ...
    TGDisclosureActionCollectionItem *_moneyTalkSettingsItem;
...
- (id)initWithUid:(int32_t)uid
{
    ...
    if (self)
    {
        ...
        _moneyTalkSettingsItem = [[TGDisclosureActionCollectionItem alloc] initWithTitle:LOC(@"Settings.MoneyTalk.ButtonTitle") action:@selector(moneyTalkSettingsPressed)];
        _moneyTalkSettingsItem.deselectAutomatically = true;
        TGCollectionMenuSection *moneyTalkSection = [[TGCollectionMenuSection alloc] initWithItems:@[_moneyTalkSettingsItem]];
        [self.menuSections addSection:moneyTalkSection];
...
- (void)moneyTalkSettingsPressed
{
    TCSMTSettingsTableViewController *moneyTalkSettingsController = [[TCSMTSettingsTableViewController alloc] init];
    UINavigationController *navigationController = [[UINavigationController alloc] initWithRootViewController:moneyTalkSettingsController];
    navigationController.modalPresentationStyle = UIModalPresentationFormSheet;
    
    [[TCSMTLoginController sharedInstance] showViewController:navigationController fromViewController:self.navigationController];
}
