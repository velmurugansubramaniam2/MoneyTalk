...
- (void)loadView
{
    ...
    _scrollView.contentSize = CGSizeMake(screenSize.width * kPagesCount, screenSize.height);
    ...
    _pagerView = [[TGPagerView alloc] initWithDotColors:@[UIColorRGB(0x2ca5e0), UIColorRGB(0x2ca5e0), UIColorRGB(0x2ca5e0), UIColorRGB(0x2f5a83), UIColorRGB(0x7a8185), UIColorRGB(0x3097f6)]];
    [_pagerView setPagesCount:kPagesCount];
    _pagerView.frame = CGRectMake(0.0f, isWidescreen ? 487.0f : 400.0f, screenSize.width, 7.0f);
    [self.view addSubview:_pagerView];
    //rfhnbyrb nen
    NSArray *images = @[
                        [UIImage imageNamed:@"tour_1"],
                        [UIImage imageNamed:@"tour_2"],
                        [UIImage imageNamed:@"tour_3"]
...
//        [UIImage imageNamed:@"Tour.bundle/TourIcon4.png"]
    ...
    NSArray *titles = @[
        TGLocalized(@"Welcome.Title1"),
        TGLocalized(@"Welcome.Title2"),
        TGLocalized(@"Welcome.Title3")
//        TGLocalized(@"Tour.Title3"),
//        TGLocalized(@"Tour.Title4"),
//        TGLocalized(@"Tour.Title5")
    ];
    NSArray *texts = @[
        TGLocalized(@"Welcome.Text1"),
        TGLocalized(@"Welcome.Text2"),
        TGLocalized(@"Welcome.Text3")
